...
Returns:
    A list of ``torch.Tensor``. Each tensor in the list corresponds to a parameter.
      ...
      .def(
          "is_the_last_bucket_to_allreduce_new",
          &::c10d::GradBucket::isTheLastBucketToAllreduceNew,
          py::arg("index"),
          py::call_guard<py::gil_scoped_release>(),
          R"(
Returns:
...
Returns:
    ...
    This also means that this bucket corresponds to the first few layers in the forward pass.
      ...
      .def(
          "get_bucket_number",
          &::c10d::GradBucket::getBucketNumber,
          py::call_guard<py::gil_scoped_release>(),
          R"(
Returns:
    The bucket number in this iteration.
)")
      .def(
          "set_tensor",
